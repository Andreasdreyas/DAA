...
<div style="background-color: #ffffff; padding: 20px; border-radius: 15px; box-shadow: 0px 4px 10px rgba(0, 0, 0, 0.1);">
    <p style="text-align: justify; font-size: 16px; font-family: 'Arial, sans-serif'; color: #808080;">
        <b>NocturnEnt</b> is an innovative technology company committed to revolutionizing the electricity distribution system 
...
faq_data = {
    "General Information": {
        "What services does NocturnEnt offer?": "We specialize in optimizing electricity distribution, network analysis, and providing sustainable energy solutions.",
        "Who can benefit from NocturnEnt's services?": "Our solutions are tailored for municipalities, businesses, and communities, making them scalable for both urban and rural regions."
    },
    "About the Analysis": {
...
st.write("""
📧 Email: [info@nocturnent.com](mailto:info@nocturnent.com)  
🌐 Website: [www.nocturnent.com](http://www.nocturnent.com)  
📍 Address: 123 Energy Lane, New Delhi, India  
☎️ Phone: +91 9876543210
""")

st.markdown("""
<div style="text-align: center; color: gray;">
    <small>© 2024 NocturnEnt. All rights reserved.</small>
</div>
""", unsafe_allow_html=True)